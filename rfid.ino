...
MFRC522::MIFARE_Key key;  // Certifique-se de que esta linha está declarada corretamente!
...
void leituraDados() {
  ...
  status = mfrc522.PCD_Authenticate(MFRC522::PICC_CMD_MF_AUTH_KEY_A, bloco, &key, &(mfrc522.uid)); // linha 834 do MFRC522.cpp
...
int menu() {
  ...
  return (op-48); //do valor lido, subtraímos o 48 que é o ZERO da tabela ASCII
}
